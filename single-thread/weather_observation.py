#Ha Noi weather observation from 2011 to 2023
    ...
    if element:
        ...
        if title:
            ...
            if len(parts) >= 3:
                ...
                station_data.update({"time": time, "weather observation": weather_observation})
            else:
...
output_file = "DS-project/HaNoi_weather_observation_2011_2023.csv"
